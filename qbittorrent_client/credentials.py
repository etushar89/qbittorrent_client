...
class CredentialsManager:
    ...
    def get_url_username_password(self, url: Optional[str] = None, 
        ...
        final_url = url or (cached_credentials.get("url") if cached_credentials else "http://localhost:8080")
        final_username = username or (cached_credentials.get("username") if cached_credentials else None)
        final_password = password or (cached_credentials.get("password") if cached_credentials else None)
